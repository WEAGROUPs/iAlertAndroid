...
public class aboutFragment extends SherlockFragment{
	...
	//declaration of global variables to be used in implementing the journalist's login activity.
	...
	//Declaration of Local variables to be used in the login activity 
	private ProgressDialog pDialog;
       ...
       String llname;
		...
		boolean login_token=false;
		 ...
		 public static String url_login = "http://ialert.ugisoft.com/ialert/login_file.php";
		...
		// private static final String TAG_SUCCESS1 = "success";
		    ...
		    //Referencing the login actions with the XML layout(login.xml)
			...
			login.setOnClickListener(new View.OnClickListener() {
				...
				@Override
				//Method to control user actions while logging in(checking whether both fields have been filled in)
