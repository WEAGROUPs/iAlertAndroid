...
public class FetchProgramTask extends AsyncTask<String, Void, String>{
    ...
    protected void onPostExecute(String sJson) {
        ...
        try {
            ...
            // create apps list
            List<programs> apps = new ArrayList<programs>();
             
            for(int i=0; i<aJson.length(); i++) {
                JSONObject json = aJson.getJSONObject(i);
                programs app = new programs();
                app.setname(json.getString("name"));
                app.setid(json.getString("id"));
                app.setface(json.getString("image"));
