...
public class MainActivity extends SherlockFragmentActivity {
	 DrawerLayout mDrawerLayout;
	  ...
	  FacebookFrag facebook = new FacebookFrag();
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	    		    ...
	    		    if((lname.equalsIgnoreCase(no) && fname.equalsIgnoreCase(no)))
		   		  ...
		   		  stopService(new Intent(getBaseContext(), notificationService.class));
		   	    	 ...
		   	    	 else
		   	    	 {
		   	    		...
		   	    		Toast.makeText(this, "job="+job, Toast.LENGTH_SHORT).show();
		   	    		 if(job==3)
		   	    		 {
	        ...
	        // Generate title
	        title = new String[] {"Home","Report News","News Updates","NTV Facebook","Visit NTV", "Help",
	                "NTV Guide" ,"Login","Settings","Quit"};
	      ...
	      //  mMode = startActionMode(new AnActionModeOfEpicProportions());
	        ...
	        // Generate subtitle
	        subtitle = new String[] { "Home","general","Subtitle Fragment 1","Subtitle Fragment a", "Subtitle Fragment 2",
	                "Subtitle Fragment 3","Subtitle Fragment 4" ,"Subtitle Fragment 5","payments","quit"};
	       // getSupportActionBar().setBackgroundDrawable(getResources().getDrawable(R.drawable.actionbar_background));
			
	        // Generate icon
	        icon = new int[] {R.drawable.homez,R.drawable.report, R.drawable.updates,R.drawable.facebk,R.drawable.visit, R.drawable.help,
	                R.drawable.guide ,R.drawable.login,R.drawable.settings,R.drawable.quit};
	    ...
	    public boolean onOptionsItemSelected(MenuItem item) {
	        ...
	        //Using the botton screen for settings,quiting and about   
...
*/
	        ...
	        case 3:
		          ...
		          ft.replace(R.id.content_frame, facebook);
