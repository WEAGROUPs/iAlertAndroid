	...
	public class UpdatesAdapter extends ArrayAdapter<Application>{
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	        ...
	        if(app != null) {
	            ...
	            if(audioText != null) audioText.setText(app.getaudio());
			       
	            if(videoText != null) videoText.setText(app.getvideo());
	            ...
	            if(senderlocationText != null) senderlocationText.setText(app.getsenderlocation());
	            if(idText != null) idText.setText(app.getid());
	            ...
	            */
	            ...
	            if(icon != null) {
	               ...
	               // ImageView imgAvatar = (ImageView)findViewById(R.id.appIcon);
	        		...
	        		String url_news_updates = "http://ialert.ugisoft.com/ialert/image_uploads/"+app.getface();
